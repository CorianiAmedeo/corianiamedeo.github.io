...
<section class="background-dark">
    <div id="title">
        <h2 class="text-5xl font-base text-light-primary">Making work <br>stand out</h2>
    </div>
    <div class="content">
...
<style>
    ...
    #cards-text > li {
        border-left: 1px solid hsla(var(--primary), .4);
        border-right: 1px solid hsla(var(--primary), .4);
    }
    ...
    #carousel-pagination > .current-0 {
        position: absolute;
        background-color: hsla(var(--neutral-light), .6);
        transform: translateX(0px);
    ...
    #carousel-pagination > .default {
        background-color: hsla(var(--neutral-light), .3);
    }
